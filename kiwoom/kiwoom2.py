...
#         self.use_money_percent = 0.5 #예수금에서 실제 사용 할 비율
...
#         self.setControl('KHOPENAPI.KHOpenAPICtrl.1') #레지스트리에 저장된 api모듈 불러오기
...
#         self.dynamicCall('SetInputValue(QString, QString, int, QString)','예수금상세현황요청',
#                          'opw00001',"0",self.screen_my_info)
#     def trdata_slot(self, sScrNo, sRQName, sTrCode, sRecordName, sPrevNext):
#         '''
#         tr요청을 받는 구역이다!슬롯이다!
#         :param sScrNo:스크린번호
#         :param sRQName:내가 요청 했을때 지은 이름
